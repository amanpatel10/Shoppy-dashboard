...
const Ecommerce = () => {
  ...
  //note that tooltip component is used to mention the icon's properties when hovered
  return (
    <div className="mt-24">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className=" border-r-1 border-color m-4 pr-10">
              ...
              <div className="mt-8">
                <p className="text-3xl font-semibold">10000</p>
        ...
        <div>
          ...
          >
            <div className="flex justify-between items-center ">
              ...
              <div>
                <p className="text-2xl text-white font-semibold mt-8">5000</p>
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10">
            <div>
              ...
              <p className="text-gray-400">Yeary sales</p>
            </div>
